    ...
    return (
        ...
        <div className='leftWrap'>
            <div className='dateWrap'>
                ...
                <span className='locationName'>{city.city} - {city.admin_name} - {city.country}
                </span>
                </div>
                <div className='weatherContainer'>
                <img alt="ruchi" className='weatherIcon' src={`http://openweathermap.org/img/wn/${current.weather[0].icon}@2x.png`}/>
